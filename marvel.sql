...
UPDATE people SET name = 'Kate Preston' WHERE name = 'Kte Preston';
...
SELECT name FROM people WHERE name = 'Kishan Bachoo';

-- Research how to delete multiple entries from your table in a single command.

-- You can delete multiple entries using the IN and BETWEEN operators. i.e.

-- DELETE FROM table WHERE id IN (var1, var2, ...);
